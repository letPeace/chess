...
public class Test{
    ...
    public static boolean test(String testObject) throws NullPointerException, NumberFormatException, ArrayIndexOutOfBoundsException{
        ...
        if(testObject.equals("pawn")){
            ...
            Collections.addAll(getMoveSequence(),"17 16 0","21 33 1 1","33 54 1 1","54 35 1 1","35 14 1 1","14 33 1 1","33 45 1 1","45 37 1 1","37 25 1 1","25 33 1 1","33 35 0","33 24 0","33 43 0","33 12 0","78 86 1");
    ...
    private static boolean justDoIt() throws NullPointerException, NumberFormatException, ArrayIndexOutOfBoundsException{
        for(String moveData : getMoveSequence()){
            try {
                ...
                if(moveSuccess != result){
                    System.out.println("test is UNsuccessful: "+coordinateFrom+" -> "+coordinateTo+" must be "+result);
                    return false;
                } else{
                    System.out.println("["+coordinateFrom+" -> "+coordinateTo+" = "+result+"] is correct");
                }
                // TURN
